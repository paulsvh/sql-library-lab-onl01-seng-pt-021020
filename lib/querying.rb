...
def select_series_title_with_most_human_characters
  "select title.series from series join books on books.series_id = series.id join character_books on character_books.book_id = books.id join characters on characters_books.character_id = characters.id where characters.species = "human" order by count desc limit 1;"
end
